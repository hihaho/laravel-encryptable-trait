...
[![Tests](https://github.com/hihaho/laravel-encryptable-trait/actions/workflows/run-tests.yml/badge.svg)](https://github.com/hihaho/laravel-encryptable-trait/actions/workflows/run-tests.yml)
